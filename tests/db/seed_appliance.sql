...
-- data 字段对应元戎 Docker 沙箱规格（openyuanrong_api_reference.md §4.7）
INSERT INTO image(registry, service_id, framework, framework_version, is_default, data) VALUES
  ('镜像注册表', 'img_langchain_0.1.0',    'langchain',   '0.1.0', 0,
   '{"rootfs":{"type":"docker","imageurl":"registry.local/langchain:0.1.0","workdir":"/app","mounts":[]},"cpu":1,"memory":"512Mi","ports":[8080],"env":{"LC_CACHE":"/tmp/lc"},"image_module_version":"v1"}'),
  ('镜像注册表', 'img_langchain_0.2.0',    'langchain',   '0.2.0', 1,
   '{"rootfs":{"type":"docker","imageurl":"registry.local/langchain:0.2.0","workdir":"/app","mounts":[]},"cpu":2,"memory":"1Gi","ports":[8080],"env":{"LC_CACHE":"/tmp/lc2"},"image_module_version":"v1"}'),
  ('镜像注册表', 'img_llama_index_0.9.0',  'llama_index', '0.9.0', 1,
   '{"rootfs":{"type":"docker","imageurl":"registry.local/llama_index:0.9.0","workdir":"/app","mounts":[]},"cpu":2,"memory":"2Gi","ports":[9000],"env":{"LI_CACHE":"/tmp/li"},"image_module_version":"v1"}');
