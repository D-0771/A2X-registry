...
-- V2: data 扁平（无 rootfs 包装层），新增 version_key (NOT NULL) + uploaded_by 提升列
INSERT INTO image(registry, service_id, framework, framework_version, version_key, is_default, uploaded_by, data) VALUES
  ('images', 'img_langchain_0.1.0',    'langchain',   '0.1.0',  '00000.00001.00000~', 0, 'system',
   '{"imageurl":"registry.local/langchain:0.1.0","workdir":"/app","mounts":[],"cpu":1,"memory":"512Mi","ports":[8080],"env":{"LC_CACHE":"/tmp/lc"},"image_module_version":"v1","created_at":"2026-07-01T00:00:00Z"}'),
  ('images', 'img_langchain_0.2.0',    'langchain',   '0.2.0',  '00000.00002.00000~', 1, 'system',
   '{"imageurl":"registry.local/langchain:0.2.0","workdir":"/app","mounts":[],"cpu":2,"memory":"1Gi","ports":[8080],"env":{"LC_CACHE":"/tmp/lc2"},"image_module_version":"v1","created_at":"2026-07-02T00:00:00Z"}'),
  ('images', 'img_llama_index_0.9.0',  'llama_index', '0.9.0',  '00000.00009.00000~', 1, 'system',
   '{"imageurl":"registry.local/llama_index:0.9.0","workdir":"/app","mounts":[],"cpu":2,"memory":"2Gi","ports":[9000],"env":{"LI_CACHE":"/tmp/li"},"image_module_version":"v1","created_at":"2026-07-03T00:00:00Z"}');
