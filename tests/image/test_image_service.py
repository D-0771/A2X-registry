"""ImageService 业务逻辑测试（memory 后端，V2.1 runtime_spec 透传模型）。
...
def _reg(svc, fw="opencode", ver="v0.2.0", **kw):
    """Helper: call register_image with v2.1 body fields."""
...
def test_query_returns_runtime_spec_passthrough(image_svc: ImageService):
    """V2.1: runtime_spec is stored and returned as opaque JSON passthrough."""
    ...
    # V2.1: no flat imageurl/cpu/memory/ports/env fields
